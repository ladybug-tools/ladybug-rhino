...
latex_documents = [
    (master_doc, 'ladybug-rhino.tex', 'ladybug-rhino Documentation',
...
man_pages = [
    (master_doc, 'ladybug-rhino', 'ladybug-rhino Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ladybug-rhino', 'ladybug-rhino Documentation',
     author, 'ladybug-rhino', 'One line description of project.',
     'Miscellaneous'),
]
