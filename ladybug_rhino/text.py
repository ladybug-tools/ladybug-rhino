...
def rhino_text(text, plane, height, font='Arial',
    ...
    Args:
        ...
        attributes: Optional attributes for adding to the Rhino scene.
    """
    ...
    id = sc.doc.Objects.AddText(txt, attributes)
    if id != guid.Empty:
        sc.doc.Views.Redraw()
        return True
    return False
...
def grasshopper_text(text, plane, height, font='Arial',
                     horizontal_alignment=0, vertical_alignment=5):
